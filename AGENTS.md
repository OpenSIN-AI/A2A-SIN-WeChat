# A2A-SIN-WeChat — AGENTS.md

## Purpose

Autonomous WeChat messaging integration agent operating within the Team Messaging ecosystem.
...
- Prefer WeChat messaging integration and automation work.
